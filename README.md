...
這是一個每日自動化整理「設計美學、UI/UX 趨勢」與「公共治理、社會創新、數位政府」的高品質開源日報系統。本專案結合了 RSS 自動爬蟲與 **Google Gemini 3.8 Flash** 大型語言模型（支援 3.7 / 3.6 Flash 備援），不僅僅是翻譯新聞，更能深度提煉出每一件時事背後的「趨勢意義與洞見」。
